...
public class EnvelopeJsonAdapter extends JsonAdapter<Object> {
    public static final JsonAdapter.Factory FACTORY = new Factory() {
        @Override public @Nullable JsonAdapter<?> create(
            ...
            Type envelope = Types.newParameterizedTypeWithOwner(EnvelopeJsonAdapter.class, Envelope.class, type);
    ...
    @Override public Object fromJson(JsonReader reader) throws IOException {
        return delegate.fromJson(reader).result;
    }
